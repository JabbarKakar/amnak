...
class _PersonalRequestDetailScreenState extends State<PersonalRequestDetailScreen> {
  ...
  void initState() {
    super.initState();
    PersonalRequestDetailProvider personalRequestDetailProvider = Provider.of<PersonalRequestDetailProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    return LanguageDirection(
      child: Scaffold(
        appBar: AppBar(title: Text(context.t.personalRequestDetails), centerTitle: true),
        body: Padding(
