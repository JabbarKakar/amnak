...
//   void initState() {
//     super.initState();
//     // Fetch safety check items when the screen initializes
...
//     // Listen to the provider for safety check items
...
// Assuming other imports and classes (ProjectsCubit, SafetyCheckItemsProvider, etc.) are defined
