...
class WalkieTalkieProjectsPage extends StatefulWidget {
  const WalkieTalkieProjectsPage({super.key});

  @override
  State<WalkieTalkieProjectsPage> createState() => _ProjectsPageState();
}

class _ProjectsPageState extends State<WalkieTalkieProjectsPage> {
